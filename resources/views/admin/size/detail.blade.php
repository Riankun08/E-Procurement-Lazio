                ...
                <div class="col-md-12">
                    <form class="needs-validation" action="#" method="POST" novalidate="" enctype="multipart/form-data">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        <input type="number" class="form-control" value="{{ isset($data) ? @$data->size : ''}}" name="size" readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        <input type="text" class="form-control" value="{{ isset($data) ? @$data->centimeter : ''}}" name="centimeter" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Inci</label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control" value="{{ isset($data) ? @$data->inch : ''}}" name="inch" readonly>
                        </div>
                    </div>
