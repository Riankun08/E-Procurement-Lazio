...
<link rel="stylesheet" href="{{asset('template/base-admin-new/vendors/datatables.net-bs4/dataTables.bootstrap4.css')}}">
<link rel="stylesheet" href="{{asset('template/base-admin-new/vendors/ti-icons/css/themify-icons.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('template/base-admin-new/js/select.dataTables.min.css')}}">
